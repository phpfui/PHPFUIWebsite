...
class ContactResource_2 extends \PHPFUI\ConstantContact\Definition\Base
	{
	/**
	 * @var uuid $contact_id Unique ID for each contact resource
	 ...
	 * @var date-time $updated_at System generated date and time that the contact was last updated, in ISO-8601 format.
	 * @var date $deleted_at For deleted contacts (<code>email_address</code> contains <code>opt_out_source</code> and <code>opt_out_date</code>), shows the date of deletion.
	...
	protected static array $fields = [
		'contact_id' => 'uuid',
		'email_address' => 'PHPFUI\ConstantContact\Definition\EmailAddress::class',
		'first_name' => 'string',
		'last_name' => 'string',
		'job_title' => 'string',
		'company_name' => 'string',
