...
class EmailLinkClickCount extends \PHPFUI\ConstantContact\Definition\Base
	 ...
	 * @var uuid $list_id If the link uses the click segmentation feature, this property contains the contact list linked with the <code>list_action</code> property.
