...
class WWWAdminBase extends WWWBase implements \Stringable
	...
	public function home() : void
		...
		$ul->addItem(new \PHPFUI\ListItem(new \PHPFUI\Link("/BuriedTreasure/Admin/{$section}/list", "Edit {$section}", false)));
		$ul->addItem(new \PHPFUI\ListItem(new \PHPFUI\Link("/BuriedTreasure/Admin/{$section}/merge", "Merge {$section}", false)));
	...
	public function list() : void
		...
		$title = $this->title;
		$view->addCustomColumn($this->fieldName, static fn (array $row) : \PHPFUI\Link => new \PHPFUI\Link("/BuriedTreasure/Admin/{$title}/edit/{$row[$fieldName . 'Id']}", $row[$fieldName], false));
