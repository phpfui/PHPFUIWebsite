...
class GPX2CueSheet
	...
	public function render() : \PHPFUI\Container
		...
		$callout->add("Convert a {$gpxLink} file to a {$PDFLink} version of a Cue Sheet. Drag in a {$gpxLink} file and press Upload to download a {$PDFLink} version of a cue sheet.");
