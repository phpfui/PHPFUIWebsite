...
abstract class AbstractAPI
{
     ...
     */
    public function setHTTPOption(string $option, $value) : \Cloudcogs\ConstantContact\Api\AbstractAPI
    {
        $this->HTTPRequestOptions[$option] = $value;
        return $this;
    }

    public function HTTPClientProxy() : \GuzzleHttp\Client
    {
	 ...
	 * @throws ForbiddenRequest
	 * @throws ResourceNotFound
	 * @throws Conflict
	 * @throws UnsupportedMediaType
	 * @throws InternalError
	 * @throws TemporarilyUnavailable
	 * @throws \Exception
	 */
    protected function ThrowException(int $statusCode) : void
    {
        switch ($statusCode)
        {
            case 202:
